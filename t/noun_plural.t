...
is noun(q{scapula})->plural,   q{scapulae}  => q{plural: 'scapula' --> 'scapulae'};
is noun(q{scapulae})->plural, q{scapulae}  => q{plural: 'scapulae' --> 'scapulae'};
...
is noun(q{synapticula})->plural,   q{synapticula}  => q{plural: 'synapticula' --> 'synapticula'};
...
is noun(q{carcinoma})->plural,   q{carcinomata}  => q{plural: 'carcinoma' --> 'carcinomata'};
is noun(q{carcinomata})->plural, q{carcinomata}  => q{plural: 'carcinomata' --> 'carcinomata'};
...
is noun(q{melanoma})->plural,   q{melanomata}  => q{plural: 'melanoma' --> 'melanomata'};
is noun(q{melanomata})->plural, q{melanomata}  => q{plural: 'melanomata' --> 'melanomata'};
...
is noun(q{charisma})->plural,   q{charismata}  => q{plural: 'charisma' --> 'charismata'};
is noun(q{charismata})->plural, q{charismata}  => q{plural: 'charismata' --> 'charismata'};
...
is noun(q{synapticulum})->plural,   q{synapticula}  => q{plural: 'synapticulum' --> 'synapticula'};
