...
is verb(q{thinks})->past, q{thought}  => q{past 'thinks' --> 'thought'};
...
is verb(q{taken})->past, q{took}  => q{past 'taken' --> 'took'};
is verb(q{diving})->past, q{dived}  => q{past 'diving' --> 'dived'};
is verb(q{serve})->past, q{served}  => q{past 'serve' --> 'served'};
is verb(q{shod})->past, q{shod}  => q{past 'shod' --> 'shod'};
is verb(q{irising})->past, q{irised}  => q{past 'irising' --> 'irised'};
is verb(q{light})->past, q{lit}  => q{past 'light' --> 'lit'};
is verb(q{lets})->past, q{let}  => q{past 'lets' --> 'let'};
...
is verb(q{spells})->past, q{spelled}  => q{past 'spells' --> 'spelled'};
is verb(q{awakes})->past, q{awoke}  => q{past 'awakes' --> 'awoke'};
is verb(q{wind})->past, q{wound}  => q{past 'wind' --> 'wound'};
...
is verb(q{clads})->past, q{clad}  => q{past 'clads' --> 'clad'};
...
is verb(q{lights})->past, q{lit}  => q{past 'lights' --> 'lit'};
...
is verb(q{teaches})->past, q{taught}  => q{past 'teaches' --> 'taught'};
is verb(q{considers})->past, q{considered}  => q{past 'considers' --> 'considered'};
is verb(q{stayed})->past, q{stayed}  => q{past 'stayed' --> 'stayed'};
is verb(q{swings})->past, q{swung}  => q{past 'swings' --> 'swung'};
is verb(q{setting})->past, q{set}  => q{past 'setting' --> 'set'};
...
is verb(q{worked})->past, q{worked}  => q{past 'worked' --> 'worked'};
...
is verb(q{slung})->past, q{slung}  => q{past 'slung' --> 'slung'};
...
is verb(q{creates})->past, q{created}  => q{past 'creates' --> 'created'};
...
is verb(q{splitting})->past, q{split}  => q{past 'splitting' --> 'split'};
...
is verb(q{making})->past, q{made}  => q{past 'making' --> 'made'};
is verb(q{striking})->past, q{struck}  => q{past 'striking' --> 'struck'};
...
is verb(q{mowing})->past, q{mowed}  => q{past 'mowing' --> 'mowed'};
is verb(q{allowing})->past, q{allowed}  => q{past 'allowing' --> 'allowed'};
...
is verb(q{heard})->past, q{heard}  => q{past 'heard' --> 'heard'};
is verb(q{teaching})->past, q{taught}  => q{past 'teaching' --> 'taught'};
...
is verb(q{sew})->past, q{sewed}  => q{past 'sew' --> 'sewed'};
is verb(q{spoils})->past, q{spoilt}  => q{past 'spoils' --> 'spoilt'};
is verb(q{slings})->past, q{slung}  => q{past 'slings' --> 'slung'};
...
is verb(q{wetted})->past, q{wet}  => q{past 'wetted' --> 'wet'};
...
is verb(q{feeding})->past, q{fed}  => q{past 'feeding' --> 'fed'};
...
is verb(q{think})->past, q{thought}  => q{past 'think' --> 'thought'};
is verb(q{sweeping})->past, q{swept}  => q{past 'sweeping' --> 'swept'};
is verb(q{stuck})->past, q{stuck}  => q{past 'stuck' --> 'stuck'};
...
is verb(q{adds})->past, q{added}  => q{past 'adds' --> 'added'};
...
is verb(q{inputs})->past, q{input}  => q{past 'inputs' --> 'input'};
...
is verb(q{believed})->past, q{believed}  => q{past 'believed' --> 'believed'};
...
is verb(q{spreading})->past, q{spread}  => q{past 'spreading' --> 'spread'};
is verb(q{flees})->past, q{fled}  => q{past 'flees' --> 'fled'};
is verb(q{make})->past, q{made}  => q{past 'make' --> 'made'};
is verb(q{mown})->past, q{mowed}  => q{past 'mown' --> 'mowed'};
is verb(q{slain})->past, q{slew}  => q{past 'slain' --> 'slew'};
is verb(q{continues})->past, q{continued}  => q{past 'continues' --> 'continued'};
is verb(q{allow})->past, q{allowed}  => q{past 'allow' --> 'allowed'};
...
is verb(q{alights})->past, q{alighted}  => q{past 'alights' --> 'alighted'};
is verb(q{input})->past, q{input}  => q{past 'input' --> 'input'};
is verb(q{douching})->past, q{douched}  => q{past 'douching' --> 'douched'};
is verb(q{freezing})->past, q{froze}  => q{past 'freezing' --> 'froze'};
...
is verb(q{slept})->past, q{slept}  => q{past 'slept' --> 'slept'};
is verb(q{menuing})->past, q{menued}  => q{past 'menuing' --> 'menued'};
is verb(q{sent})->past, q{sent}  => q{past 'sent' --> 'sent'};
...
is verb(q{serving})->past, q{served}  => q{past 'serving' --> 'served'};
...
is verb(q{wed})->past, q{wed}  => q{past 'wed' --> 'wed'};
...
is verb(q{teach})->past, q{taught}  => q{past 'teach' --> 'taught'};
is verb(q{set})->past, q{set}  => q{past 'set' --> 'set'};
...
is verb(q{spread})->past, q{spread}  => q{past 'spread' --> 'spread'};
...
is verb(q{throws})->past, q{threw}  => q{past 'throws' --> 'threw'};
...
is verb(q{plays})->past, q{played}  => q{past 'plays' --> 'played'};
is verb(q{swear})->past, q{swore}  => q{past 'swear' --> 'swore'};
is verb(q{clothes})->past, q{clothed}  => q{past 'clothes' --> 'clothed'};
is verb(q{does})->past, q{did}  => q{past 'does' --> 'did'};
is verb(q{playing})->past, q{played}  => q{past 'playing' --> 'played'};
is verb(q{bind})->past, q{bound}  => q{past 'bind' --> 'bound'};
is verb(q{shining})->past, q{shone}  => q{past 'shining' --> 'shone'};
is verb(q{smitten})->past, q{smote}  => q{past 'smitten' --> 'smote'};
is verb(q{hiding})->past, q{hid}  => q{past 'hiding' --> 'hid'};
...
is verb(q{considering})->past, q{considered}  => q{past 'considering' --> 'considered'};
...
is verb(q{mows})->past, q{mowed}  => q{past 'mows' --> 'mowed'};
is verb(q{offered})->past, q{offered}  => q{past 'offered' --> 'offered'};
is verb(q{won})->past, q{won}  => q{past 'won' --> 'won'};
is verb(q{slid})->past, q{slid}  => q{past 'slid' --> 'slid'};
is verb(q{struck})->past, q{struck}  => q{past 'struck' --> 'struck'};
is verb(q{bleed})->past, q{bled}  => q{past 'bleed' --> 'bled'};
is verb(q{shut})->past, q{shut}  => q{past 'shut' --> 'shut'};
is verb(q{tears})->past, q{tore}  => q{past 'tears' --> 'tore'};
is verb(q{shines})->past, q{shone}  => q{past 'shines' --> 'shone'};
is verb(q{selling})->past, q{sold}  => q{past 'selling' --> 'sold'};
is verb(q{willing})->past, q{willed}  => q{past 'willing' --> 'willed'};
is verb(q{forbidden})->past, q{forbade}  => q{past 'forbidden' --> 'forbade'};
is verb(q{slinging})->past, q{slung}  => q{past 'slinging' --> 'slung'};
is verb(q{dig})->past, q{dug}  => q{past 'dig' --> 'dug'};
is verb(q{wets})->past, q{wet}  => q{past 'wets' --> 'wet'};
...
is verb(q{thought})->past, q{thought}  => q{past 'thought' --> 'thought'};
is verb(q{drinks})->past, q{drank}  => q{past 'drinks' --> 'drank'};
is verb(q{wet})->past, q{wet}  => q{past 'wet' --> 'wet'};
is verb(q{spell})->past, q{spelled}  => q{past 'spell' --> 'spelled'};
is verb(q{offer})->past, q{offered}  => q{past 'offer' --> 'offered'};
...
is verb(q{sticking})->past, q{stuck}  => q{past 'sticking' --> 'stuck'};
...
is verb(q{splits})->past, q{split}  => q{past 'splits' --> 'split'};
is verb(q{add})->past, q{added}  => q{past 'add' --> 'added'};
is verb(q{shedding})->past, q{shed}  => q{past 'shedding' --> 'shed'};
is verb(q{looked})->past, q{looked}  => q{past 'looked' --> 'looked'};
is verb(q{sticks})->past, q{stuck}  => q{past 'sticks' --> 'stuck'};
is verb(q{doing})->past, q{did}  => q{past 'doing' --> 'did'};
...
is verb(q{including})->past, q{included}  => q{past 'including' --> 'included'};
is verb(q{vex})->past, q{vexed}  => q{past 'vex' --> 'vexed'};
is verb(q{spun})->past, q{spun}  => q{past 'spun' --> 'spun'};
is verb(q{go})->past, q{went}  => q{past 'go' --> 'went'};
is verb(q{created})->past, q{created}  => q{past 'created' --> 'created'};
is verb(q{quizzed})->past, q{quizzed}  => q{past 'quizzed' --> 'quizzed'};
is verb(q{alight})->past, q{alighted}  => q{past 'alight' --> 'alighted'};
is verb(q{writes})->past, q{wrote}  => q{past 'writes' --> 'wrote'};
is verb(q{know})->past, q{knew}  => q{past 'know' --> 'knew'};
is verb(q{happens})->past, q{happened}  => q{past 'happens' --> 'happened'};
is verb(q{taking})->past, q{took}  => q{past 'taking' --> 'took'};
is verb(q{talks})->past, q{talked}  => q{past 'talks' --> 'talked'};
is verb(q{consider})->past, q{considered}  => q{past 'consider' --> 'considered'};
...
is verb(q{freeze})->past, q{froze}  => q{past 'freeze' --> 'froze'};
is verb(q{gild})->past, q{gilded}  => q{past 'gild' --> 'gilded'};
is verb(q{shone})->past, q{shone}  => q{past 'shone' --> 'shone'};
is verb(q{casting})->past, q{cast}  => q{past 'casting' --> 'cast'};
is verb(q{slay})->past, q{slew}  => q{past 'slay' --> 'slew'};
is verb(q{sewn})->past, q{sewed}  => q{past 'sewn' --> 'sewed'};
...
is verb(q{lit})->past, q{lit}  => q{past 'lit' --> 'lit'};
is verb(q{shearing})->past, q{sheared}  => q{past 'shearing' --> 'sheared'};
is verb(q{create})->past, q{created}  => q{past 'create' --> 'created'};
is verb(q{using})->past, q{used}  => q{past 'using' --> 'used'};
is verb(q{weaves})->past, q{wove}  => q{past 'weaves' --> 'wove'};
is verb(q{frozen})->past, q{froze}  => q{past 'frozen' --> 'froze'};
...
is verb(q{writing})->past, q{wrote}  => q{past 'writing' --> 'wrote'};
...
is verb(q{call})->past, q{called}  => q{past 'call' --> 'called'};
is verb(q{appeared})->past, q{appeared}  => q{past 'appeared' --> 'appeared'};
is verb(q{quit})->past, q{quit}  => q{past 'quit' --> 'quit'};
is verb(q{sets})->past, q{set}  => q{past 'sets' --> 'set'};
is verb(q{hears})->past, q{heard}  => q{past 'hears' --> 'heard'};
...
is verb(q{adding})->past, q{added}  => q{past 'adding' --> 'added'};
...
is verb(q{spilling})->past, q{spilled}  => q{past 'spilling' --> 'spilled'};
...
is verb(q{tries})->past, q{tried}  => q{past 'tries' --> 'tried'};
...
is verb(q{open})->past, q{opened}  => q{past 'open' --> 'opened'};
is verb(q{appear})->past, q{appeared}  => q{past 'appear' --> 'appeared'};
is verb(q{sit})->past, q{sat}  => q{past 'sit' --> 'sat'};
is verb(q{rids})->past, q{rid}  => q{past 'rids' --> 'rid'};
is verb(q{alighted})->past, q{alighted}  => q{past 'alighted' --> 'alighted'};
is verb(q{ridding})->past, q{rid}  => q{past 'ridding' --> 'rid'};
is verb(q{written})->past, q{wrote}  => q{past 'written' --> 'wrote'};
...
is verb(q{pays})->past, q{paid}  => q{past 'pays' --> 'paid'};
...
is verb(q{weds})->past, q{wed}  => q{past 'weds' --> 'wed'};
...
is verb(q{clad})->past, q{clad}  => q{past 'clad' --> 'clad'};
...
is verb(q{shorn})->past, q{sheared}  => q{past 'shorn' --> 'sheared'};
...
is verb(q{spins})->past, q{spun}  => q{past 'spins' --> 'spun'};
is verb(q{spelling})->past, q{spelled}  => q{past 'spelling' --> 'spelled'};
...
is verb(q{do})->past, q{did}  => q{past 'do' --> 'did'};
...
is verb(q{spreads})->past, q{spread}  => q{past 'spreads' --> 'spread'};
...
is verb(q{melted})->past, q{melted}  => q{past 'melted' --> 'melted'};
...
is verb(q{done})->past, q{did}  => q{past 'done' --> 'did'};
...
is verb(q{winding})->past, q{wound}  => q{past 'winding' --> 'wound'};
is verb(q{mow})->past, q{mowed}  => q{past 'mow' --> 'mowed'};
is verb(q{spin})->past, q{spun}  => q{past 'spin' --> 'spun'};
is verb(q{shoot})->past, q{shot}  => q{past 'shoot' --> 'shot'};
...
is verb(q{spills})->past, q{spilled}  => q{past 'spills' --> 'spilled'};
...
is verb(q{inputting})->past, q{input}  => q{past 'inputting' --> 'input'};
is verb(q{stopping})->past, q{stopped}  => q{past 'stopping' --> 'stopped'};
is verb(q{shine})->past, q{shone}  => q{past 'shine' --> 'shone'};
...
is verb(q{opening})->past, q{opened}  => q{past 'opening' --> 'opened'};
...
is verb(q{throwing})->past, q{threw}  => q{past 'throwing' --> 'threw'};
...
is verb(q{used})->past, q{used}  => q{past 'used' --> 'used'};
...
is verb(q{turning})->past, q{turned}  => q{past 'turning' --> 'turned'};
...
is verb(q{throw})->past, q{threw}  => q{past 'throw' --> 'threw'};
...
is verb(q{appears})->past, q{appeared}  => q{past 'appears' --> 'appeared'};
...
is verb(q{thrown})->past, q{threw}  => q{past 'thrown' --> 'threw'};
is verb(q{betting})->past, q{bet}  => q{past 'betting' --> 'bet'};
is verb(q{believe})->past, q{believed}  => q{past 'believe' --> 'believed'};
is verb(q{melting})->past, q{melted}  => q{past 'melting' --> 'melted'};
is verb(q{spits})->past, q{spat}  => q{past 'spits' --> 'spat'};
is verb(q{calling})->past, q{called}  => q{past 'calling' --> 'called'};
...
is verb(q{spilled})->past, q{spilled}  => q{past 'spilled' --> 'spilled'};
is verb(q{serves})->past, q{served}  => q{past 'serves' --> 'served'};
...
is verb(q{served})->past, q{served}  => q{past 'served' --> 'served'};
...
is verb(q{lighting})->past, q{lit}  => q{past 'lighting' --> 'lit'};
...
is verb(q{sends})->past, q{sent}  => q{past 'sends' --> 'sent'};
is verb(q{called})->past, q{called}  => q{past 'called' --> 'called'};
is verb(q{overtakes})->past, q{overtook}  => q{past 'overtakes' --> 'overtook'};
is verb(q{wedding})->past, q{wed}  => q{past 'wedding' --> 'wed'};
is verb(q{running})->past, q{ran}  => q{past 'running' --> 'ran'};
is verb(q{remember})->past, q{remembered}  => q{past 'remember' --> 'remembered'};
is verb(q{starts})->past, q{started}  => q{past 'starts' --> 'started'};
is verb(q{mistake})->past, q{mistook}  => q{past 'mistake' --> 'mistook'};
is verb(q{shoe})->past, q{shod}  => q{past 'shoe' --> 'shod'};
is verb(q{sold})->past, q{sold}  => q{past 'sold' --> 'sold'};
is verb(q{shuts})->past, q{shut}  => q{past 'shuts' --> 'shut'};
...
is verb(q{spill})->past, q{spilled}  => q{past 'spill' --> 'spilled'};
is verb(q{prove})->past, q{proved}  => q{past 'prove' --> 'proved'};
is verb(q{foretell})->past, q{foretold}  => q{past 'foretell' --> 'foretold'};
is verb(q{creating})->past, q{created}  => q{past 'creating' --> 'created'};
...
is verb(q{included})->past, q{included}  => q{past 'included' --> 'included'};
...
is verb(q{sewing})->past, q{sewed}  => q{past 'sewing' --> 'sewed'};
...
is verb(q{wound})->past, q{wound}  => q{past 'wound' --> 'wound'};
is verb(q{sneaks})->past, q{sneaked}  => q{past 'sneaks' --> 'sneaked'};
is verb(q{reading})->past, q{read}  => q{past 'reading' --> 'read'};
...
is verb(q{includes})->past, q{included}  => q{past 'includes' --> 'included'};
is verb(q{shot})->past, q{shot}  => q{past 'shot' --> 'shot'};
is verb(q{split})->past, q{split}  => q{past 'split' --> 'split'};
is verb(q{understood})->past, q{understood}  => q{past 'understood' --> 'understood'};
is verb(q{believes})->past, q{believed}  => q{past 'believes' --> 'believed'};
...
is verb(q{sling})->past, q{slung}  => q{past 'sling' --> 'slung'};
...
is verb(q{appearing})->past, q{appeared}  => q{past 'appearing' --> 'appeared'};
...
is verb(q{include})->past, q{included}  => q{past 'include' --> 'included'};
is verb(q{lending})->past, q{lent}  => q{past 'lending' --> 'lent'};
is verb(q{shit})->past, q{shat}  => q{past 'shit' --> 'shat'};
is verb(q{standing})->past, q{stood}  => q{past 'standing' --> 'stood'};
is verb(q{cut})->past, q{cut}  => q{past 'cut' --> 'cut'};
is verb(q{run})->past, q{ran}  => q{past 'run' --> 'ran'};
is verb(q{lent})->past, q{lent}  => q{past 'lent' --> 'lent'};
...
is verb(q{letting})->past, q{let}  => q{past 'letting' --> 'let'};
...
is verb(q{take})->past, q{took}  => q{past 'take' --> 'took'};
is verb(q{allows})->past, q{allowed}  => q{past 'allows' --> 'allowed'};
...
is verb(q{opened})->past, q{opened}  => q{past 'opened' --> 'opened'};
is verb(q{dwelt})->past, q{dwelt}  => q{past 'dwelt' --> 'dwelt'};
is verb(q{goes})->past, q{went}  => q{past 'goes' --> 'went'};
is verb(q{shutting})->past, q{shut}  => q{past 'shutting' --> 'shut'};
is verb(q{added})->past, q{added}  => q{past 'added' --> 'added'};
...
is verb(q{clothed})->past, q{clothed}  => q{past 'clothed' --> 'clothed'};
...
is verb(q{try})->past, q{tried}  => q{past 'try' --> 'tried'};
...
is verb(q{made})->past, q{made}  => q{past 'made' --> 'made'};
is verb(q{staves})->past, q{staved}  => q{past 'staves' --> 'staved'};
is verb(q{shrinking})->past, q{shrank}  => q{past 'shrinking' --> 'shrank'};
is verb(q{turns})->past, q{turned}  => q{past 'turns' --> 'turned'};
is verb(q{read})->past, q{read}  => q{past 'read' --> 'read'};
is verb(q{paying})->past, q{paid}  => q{past 'paying' --> 'paid'};
...
is verb(q{uses})->past, q{used}  => q{past 'uses' --> 'used'};
is verb(q{sending})->past, q{sent}  => q{past 'sending' --> 'sent'};
is verb(q{fits})->past, q{fitted}  => q{past 'fits' --> 'fitted'};
is verb(q{reach})->past, q{reached}  => q{past 'reach' --> 'reached'};
is verb(q{played})->past, q{played}  => q{past 'played' --> 'played'};
is verb(q{remembering})->past, q{remembered}  => q{past 'remembering' --> 'remembered'};
is verb(q{are})->past, q{were}  => q{past 'are' --> 'were'};
is verb(q{lend})->past, q{lent}  => q{past 'lend' --> 'lent'};
is verb(q{overhear})->past, q{overheard}  => q{past 'overhear' --> 'overheard'};
is verb(q{shears})->past, q{sheared}  => q{past 'shears' --> 'sheared'};
...
is verb(q{lends})->past, q{lent}  => q{past 'lends' --> 'lent'};
...
is verb(q{strike})->past, q{struck}  => q{past 'strike' --> 'struck'};
...
is verb(q{fit})->past, q{fitted}  => q{past 'fit' --> 'fitted'};
...
is verb(q{reads})->past, q{read}  => q{past 'reads' --> 'read'};
is verb(q{quizzing})->past, q{quizzed}  => q{past 'quizzing' --> 'quizzed'};
is verb(q{bursting})->past, q{burst}  => q{past 'bursting' --> 'burst'};
is verb(q{draw})->past, q{drew}  => q{past 'draw' --> 'drew'};
is verb(q{believing})->past, q{believed}  => q{past 'believing' --> 'believed'};
...
is verb(q{tried})->past, q{tried}  => q{past 'tried' --> 'tried'};
is verb(q{fitted})->past, q{fitted}  => q{past 'fitted' --> 'fitted'};
is verb(q{sing})->past, q{sang}  => q{past 'sing' --> 'sang'};
is verb(q{tells})->past, q{told}  => q{past 'tells' --> 'told'};
...
is verb(q{sleeps})->past, q{slept}  => q{past 'sleeps' --> 'slept'};
is verb(q{fed})->past, q{fed}  => q{past 'fed' --> 'fed'};
is verb(q{feel})->past, q{felt}  => q{past 'feel' --> 'felt'};
is verb(q{spinning})->past, q{spun}  => q{past 'spinning' --> 'spun'};
...
is verb(q{spelled})->past, q{spelled}  => q{past 'spelled' --> 'spelled'};
is verb(q{forgives})->past, q{forgave}  => q{past 'forgives' --> 'forgave'};
is verb(q{thinking})->past, q{thought}  => q{past 'thinking' --> 'thought'};
is verb(q{sows})->past, q{sowed}  => q{past 'sows' --> 'sowed'};
is verb(q{breaks})->past, q{broke}  => q{past 'breaks' --> 'broke'};
is verb(q{started})->past, q{started}  => q{past 'started' --> 'started'};
...
is verb(q{shear})->past, q{sheared}  => q{past 'shear' --> 'sheared'};
is verb(q{dying})->past, q{died}  => q{past 'dying' --> 'died'};
is verb(q{string})->past, q{strung}  => q{past 'string' --> 'strung'};
is verb(q{turned})->past, q{turned}  => q{past 'turned' --> 'turned'};
is verb(q{bellyached})->past, q{bellyached}  => q{past 'bellyached' --> 'bellyached'};
is verb(q{bends})->past, q{bent}  => q{past 'bends' --> 'bent'};
is verb(q{shoots})->past, q{shot}  => q{past 'shoots' --> 'shot'};
...
is verb(q{fitting})->past, q{fitted}  => q{past 'fitting' --> 'fitted'};
is verb(q{rides})->past, q{rode}  => q{past 'rides' --> 'rode'};
is verb(q{bound})->past, q{bound}  => q{past 'bound' --> 'bound'};
is verb(q{tell})->past, q{told}  => q{past 'tell' --> 'told'};
...
is verb(q{cuts})->past, q{cut}  => q{past 'cuts' --> 'cut'};
...
is verb(q{sells})->past, q{sold}  => q{past 'sells' --> 'sold'};
...
is verb(q{telling})->past, q{told}  => q{past 'telling' --> 'told'};
...
is verb(q{sell})->past, q{sold}  => q{past 'sell' --> 'sold'};
...
is verb(q{opens})->past, q{opened}  => q{past 'opens' --> 'opened'};
...
is verb(q{woven})->past, q{wove}  => q{past 'woven' --> 'wove'};
is verb(q{continue})->past, q{continued}  => q{past 'continue' --> 'continued'};
is verb(q{send})->past, q{sent}  => q{past 'send' --> 'sent'};
is verb(q{clothe})->past, q{clothed}  => q{past 'clothe' --> 'clothed'};
is verb(q{shooting})->past, q{shot}  => q{past 'shooting' --> 'shot'};
is verb(q{needed})->past, q{needed}  => q{past 'needed' --> 'needed'};
is verb(q{freezes})->past, q{froze}  => q{past 'freezes' --> 'froze'};
is verb(q{use})->past, q{used}  => q{past 'use' --> 'used'};
...
is verb(q{hearing})->past, q{heard}  => q{past 'hearing' --> 'heard'};
is verb(q{paid})->past, q{paid}  => q{past 'paid' --> 'paid'};
is verb(q{melt})->past, q{melted}  => q{past 'melt' --> 'melted'};
is verb(q{was})->past, q{was}  => q{past 'was' --> 'was'};
is verb(q{clothing})->past, q{clothed}  => q{past 'clothing' --> 'clothed'};
...
is verb(q{wetting})->past, q{wet}  => q{past 'wetting' --> 'wet'};
is verb(q{strikes})->past, q{struck}  => q{past 'strikes' --> 'struck'};
...
is verb(q{starting})->past, q{started}  => q{past 'starting' --> 'started'};
...
is verb(q{works})->past, q{worked}  => q{past 'works' --> 'worked'};
is verb(q{binds})->past, q{bound}  => q{past 'binds' --> 'bound'};
is verb(q{sits})->past, q{sat}  => q{past 'sits' --> 'sat'};
is verb(q{weave})->past, q{wove}  => q{past 'weave' --> 'wove'};
...
is verb(q{drawn})->past, q{drew}  => q{past 'drawn' --> 'drew'};
...
is verb(q{hidden})->past, q{hid}  => q{past 'hidden' --> 'hid'};
is verb(q{spent})->past, q{spent}  => q{past 'spent' --> 'spent'};
is verb(q{stick})->past, q{stuck}  => q{past 'stick' --> 'stuck'};
...
is verb(q{stringing})->past, q{strung}  => q{past 'stringing' --> 'strung'};
...
is verb(q{alighting})->past, q{alighted}  => q{past 'alighting' --> 'alighted'};
...
is verb(q{weaving})->past, q{wove}  => q{past 'weaving' --> 'wove'};
...
is verb(q{allowed})->past, q{allowed}  => q{past 'allowed' --> 'allowed'};
...
is verb(q{considered})->past, q{considered}  => q{past 'considered' --> 'considered'};
is verb(q{undertake})->past, q{undertook}  => q{past 'undertake' --> 'undertook'};
is verb(q{offering})->past, q{offered}  => q{past 'offering' --> 'offered'};
...
is verb(q{cladding})->past, q{clad}  => q{past 'cladding' --> 'clad'};
is verb(q{stop})->past, q{stopped}  => q{past 'stop' --> 'stopped'};
is verb(q{melts})->past, q{melted}  => q{past 'melts' --> 'melted'};
...
is verb(q{play})->past, q{played}  => q{past 'play' --> 'played'};
