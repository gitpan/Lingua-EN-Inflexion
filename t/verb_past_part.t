...
is verb(q{thinks})->past_part, q{thought}  => q{past_part 'thinks' --> 'thought'};
...
is verb(q{taken})->past_part, q{taken}  => q{past_part 'taken' --> 'taken'};
is verb(q{diving})->past_part, q{dived}  => q{past_part 'diving' --> 'dived'};
is verb(q{serve})->past_part, q{served}  => q{past_part 'serve' --> 'served'};
is verb(q{shod})->past_part, q{shod}  => q{past_part 'shod' --> 'shod'};
is verb(q{irising})->past_part, q{irised}  => q{past_part 'irising' --> 'irised'};
is verb(q{light})->past_part, q{lit}  => q{past_part 'light' --> 'lit'};
is verb(q{lets})->past_part, q{let}  => q{past_part 'lets' --> 'let'};
...
is verb(q{spells})->past_part, q{spelled}  => q{past_part 'spells' --> 'spelled'};
...
is verb(q{wind})->past_part, q{wound}  => q{past_part 'wind' --> 'wound'};
...
is verb(q{clads})->past_part, q{clad}  => q{past_part 'clads' --> 'clad'};
...
is verb(q{lights})->past_part, q{lit}  => q{past_part 'lights' --> 'lit'};
...
is verb(q{teaches})->past_part, q{taught}  => q{past_part 'teaches' --> 'taught'};
is verb(q{considers})->past_part, q{considered}  => q{past_part 'considers' --> 'considered'};
...
is verb(q{setting})->past_part, q{set}  => q{past_part 'setting' --> 'set'};
...
is verb(q{worked})->past_part, q{worked}  => q{past_part 'worked' --> 'worked'};
...
is verb(q{slung})->past_part, q{slung}  => q{past_part 'slung' --> 'slung'};
...
is verb(q{creates})->past_part, q{created}  => q{past_part 'creates' --> 'created'};
...
is verb(q{splitting})->past_part, q{split}  => q{past_part 'splitting' --> 'split'};
...
is verb(q{making})->past_part, q{made}  => q{past_part 'making' --> 'made'};
is verb(q{striking})->past_part, q{struck}  => q{past_part 'striking' --> 'struck'};
...
is verb(q{mowing})->past_part, q{mown}  => q{past_part 'mowing' --> 'mown'};
is verb(q{allowing})->past_part, q{allowed}  => q{past_part 'allowing' --> 'allowed'};
...
is verb(q{heard})->past_part, q{heard}  => q{past_part 'heard' --> 'heard'};
is verb(q{teaching})->past_part, q{taught}  => q{past_part 'teaching' --> 'taught'};
...
is verb(q{sew})->past_part, q{sewn}  => q{past_part 'sew' --> 'sewn'};
is verb(q{spoils})->past_part, q{spoiled}  => q{past_part 'spoils' --> 'spoiled'};
is verb(q{slings})->past_part, q{slung}  => q{past_part 'slings' --> 'slung'};
...
is verb(q{wetted})->past_part, q{wetted}  => q{past_part 'wetted' --> 'wetted'};
...
is verb(q{taught})->past_part, q{taught}  => q{past_part 'taught' --> 'taught'};
...
is verb(q{hide})->past_part, q{hidden}  => q{past_part 'hide' --> 'hidden'};
...
is verb(q{feeding})->past_part, q{fed}  => q{past_part 'feeding' --> 'fed'};
...
is verb(q{think})->past_part, q{thought}  => q{past_part 'think' --> 'thought'};
is verb(q{sweeping})->past_part, q{swept}  => q{past_part 'sweeping' --> 'swept'};
is verb(q{stuck})->past_part, q{stuck}  => q{past_part 'stuck' --> 'stuck'};
...
is verb(q{adds})->past_part, q{added}  => q{past_part 'adds' --> 'added'};
...
is verb(q{inputs})->past_part, q{input}  => q{past_part 'inputs' --> 'input'};
...
is verb(q{believed})->past_part, q{believed}  => q{past_part 'believed' --> 'believed'};
...
is verb(q{spreading})->past_part, q{spread}  => q{past_part 'spreading' --> 'spread'};
is verb(q{flees})->past_part, q{fled}  => q{past_part 'flees' --> 'fled'};
is verb(q{make})->past_part, q{made}  => q{past_part 'make' --> 'made'};
is verb(q{mown})->past_part, q{mown}  => q{past_part 'mown' --> 'mown'};
...
is verb(q{allow})->past_part, q{allowed}  => q{past_part 'allow' --> 'allowed'};
...
is verb(q{alights})->past_part, q{alighted}  => q{past_part 'alights' --> 'alighted'};
is verb(q{input})->past_part, q{input}  => q{past_part 'input' --> 'input'};
is verb(q{douching})->past_part, q{douched}  => q{past_part 'douching' --> 'douched'};
is verb(q{freezing})->past_part, q{frozen}  => q{past_part 'freezing' --> 'frozen'};
...
is verb(q{slept})->past_part, q{slept}  => q{past_part 'slept' --> 'slept'};
is verb(q{menuing})->past_part, q{menued}  => q{past_part 'menuing' --> 'menued'};
is verb(q{sent})->past_part, q{sent}  => q{past_part 'sent' --> 'sent'};
...
is verb(q{serving})->past_part, q{served}  => q{past_part 'serving' --> 'served'};
...
is verb(q{wed})->past_part, q{wed}  => q{past_part 'wed' --> 'wed'};
...
is verb(q{teach})->past_part, q{taught}  => q{past_part 'teach' --> 'taught'};
is verb(q{set})->past_part, q{set}  => q{past_part 'set' --> 'set'};
...
is verb(q{spread})->past_part, q{spread}  => q{past_part 'spread' --> 'spread'};
...
is verb(q{throws})->past_part, q{thrown}  => q{past_part 'throws' --> 'thrown'};
...
is verb(q{plays})->past_part, q{played}  => q{past_part 'plays' --> 'played'};
is verb(q{swear})->past_part, q{sworn}  => q{past_part 'swear' --> 'sworn'};
is verb(q{clothes})->past_part, q{clothed}  => q{past_part 'clothes' --> 'clothed'};
is verb(q{does})->past_part, q{done}  => q{past_part 'does' --> 'done'};
is verb(q{broke})->past_part, q{broken}  => q{past_part 'broke' --> 'broken'};
is verb(q{playing})->past_part, q{played}  => q{past_part 'playing' --> 'played'};
is verb(q{bind})->past_part, q{bound}  => q{past_part 'bind' --> 'bound'};
is verb(q{shining})->past_part, q{shone}  => q{past_part 'shining' --> 'shone'};
is verb(q{smitten})->past_part, q{smitten}  => q{past_part 'smitten' --> 'smitten'};
is verb(q{hiding})->past_part, q{hidden}  => q{past_part 'hiding' --> 'hidden'};
...
is verb(q{considering})->past_part, q{considered}  => q{past_part 'considering' --> 'considered'};
is verb(q{froze})->past_part, q{frozen}  => q{past_part 'froze' --> 'frozen'};
...
is verb(q{feed})->past_part, q{fed}  => q{past_part 'feed' --> 'fed'};
is verb(q{working})->past_part, q{worked}  => q{past_part 'working' --> 'worked'};
is verb(q{withstanding})->past_part, q{withstood}  => q{past_part 'withstanding' --> 'withstood'};
is verb(q{draws})->past_part, q{drawn}  => q{past_part 'draws' --> 'drawn'};
is verb(q{knowing})->past_part, q{known}  => q{past_part 'knowing' --> 'known'};
is verb(q{lives})->past_part, q{lived}  => q{past_part 'lives' --> 'lived'};
is verb(q{strings})->past_part, q{strung}  => q{past_part 'strings' --> 'strung'};
...
is verb(q{sleep})->past_part, q{slept}  => q{past_part 'sleep' --> 'slept'};
...
is verb(q{threw})->past_part, q{thrown}  => q{past_part 'threw' --> 'thrown'};
...
is verb(q{mows})->past_part, q{mown}  => q{past_part 'mows' --> 'mown'};
is verb(q{offered})->past_part, q{offered}  => q{past_part 'offered' --> 'offered'};
is verb(q{won})->past_part, q{won}  => q{past_part 'won' --> 'won'};
is verb(q{slid})->past_part, q{slid}  => q{past_part 'slid' --> 'slid'};
is verb(q{struck})->past_part, q{struck}  => q{past_part 'struck' --> 'struck'};
is verb(q{bleed})->past_part, q{bled}  => q{past_part 'bleed' --> 'bled'};
is verb(q{shut})->past_part, q{shut}  => q{past_part 'shut' --> 'shut'};
is verb(q{tears})->past_part, q{torn}  => q{past_part 'tears' --> 'torn'};
is verb(q{shines})->past_part, q{shone}  => q{past_part 'shines' --> 'shone'};
is verb(q{selling})->past_part, q{sold}  => q{past_part 'selling' --> 'sold'};
...
is verb(q{slinging})->past_part, q{slung}  => q{past_part 'slinging' --> 'slung'};
is verb(q{dig})->past_part, q{dug}  => q{past_part 'dig' --> 'dug'};
is verb(q{wets})->past_part, q{wetted}  => q{past_part 'wets' --> 'wetted'};
...
is verb(q{thought})->past_part, q{thought}  => q{past_part 'thought' --> 'thought'};
is verb(q{drinks})->past_part, q{drunk}  => q{past_part 'drinks' --> 'drunk'};
is verb(q{wet})->past_part, q{wetted}  => q{past_part 'wet' --> 'wetted'};
is verb(q{spell})->past_part, q{spelled}  => q{past_part 'spell' --> 'spelled'};
is verb(q{offer})->past_part, q{offered}  => q{past_part 'offer' --> 'offered'};
...
is verb(q{sticking})->past_part, q{stuck}  => q{past_part 'sticking' --> 'stuck'};
...
is verb(q{splits})->past_part, q{split}  => q{past_part 'splits' --> 'split'};
is verb(q{add})->past_part, q{added}  => q{past_part 'add' --> 'added'};
...
is verb(q{sticks})->past_part, q{stuck}  => q{past_part 'sticks' --> 'stuck'};
is verb(q{doing})->past_part, q{done}  => q{past_part 'doing' --> 'done'};
...
is verb(q{including})->past_part, q{included}  => q{past_part 'including' --> 'included'};
is verb(q{vex})->past_part, q{vexed}  => q{past_part 'vex' --> 'vexed'};
is verb(q{spun})->past_part, q{spun}  => q{past_part 'spun' --> 'spun'};
is verb(q{go})->past_part, q{gone}  => q{past_part 'go' --> 'gone'};
is verb(q{created})->past_part, q{created}  => q{past_part 'created' --> 'created'};
is verb(q{quizzed})->past_part, q{quizzed}  => q{past_part 'quizzed' --> 'quizzed'};
is verb(q{alight})->past_part, q{alighted}  => q{past_part 'alight' --> 'alighted'};
is verb(q{writes})->past_part, q{written}  => q{past_part 'writes' --> 'written'};
...
is verb(q{taking})->past_part, q{taken}  => q{past_part 'taking' --> 'taken'};
is verb(q{talks})->past_part, q{talked}  => q{past_part 'talks' --> 'talked'};
is verb(q{consider})->past_part, q{considered}  => q{past_part 'consider' --> 'considered'};
...
is verb(q{freeze})->past_part, q{frozen}  => q{past_part 'freeze' --> 'frozen'};
is verb(q{gild})->past_part, q{gilded}  => q{past_part 'gild' --> 'gilded'};
is verb(q{mowed})->past_part, q{mown}  => q{past_part 'mowed' --> 'mown'};
is verb(q{wrote})->past_part, q{written}  => q{past_part 'wrote' --> 'written'};
is verb(q{shone})->past_part, q{shone}  => q{past_part 'shone' --> 'shone'};
is verb(q{casting})->past_part, q{cast}  => q{past_part 'casting' --> 'cast'};
is verb(q{slay})->past_part, q{slain}  => q{past_part 'slay' --> 'slain'};
is verb(q{sewn})->past_part, q{sewn}  => q{past_part 'sewn' --> 'sewn'};
...
is verb(q{lit})->past_part, q{lit}  => q{past_part 'lit' --> 'lit'};
is verb(q{shearing})->past_part, q{shorn}  => q{past_part 'shearing' --> 'shorn'};
is verb(q{create})->past_part, q{created}  => q{past_part 'create' --> 'created'};
is verb(q{using})->past_part, q{used}  => q{past_part 'using' --> 'used'};
is verb(q{weaves})->past_part, q{woven}  => q{past_part 'weaves' --> 'woven'};
is verb(q{frozen})->past_part, q{frozen}  => q{past_part 'frozen' --> 'frozen'};
is verb(q{becomes})->past_part, q{become}  => q{past_part 'becomes' --> 'become'};
is verb(q{slit})->past_part, q{slit}  => q{past_part 'slit' --> 'slit'};
is verb(q{drew})->past_part, q{drawn}  => q{past_part 'drew' --> 'drawn'};
...
is verb(q{writing})->past_part, q{written}  => q{past_part 'writing' --> 'written'};
...
is verb(q{call})->past_part, q{called}  => q{past_part 'call' --> 'called'};
is verb(q{appeared})->past_part, q{appeared}  => q{past_part 'appeared' --> 'appeared'};
is verb(q{sets})->past_part, q{set}  => q{past_part 'sets' --> 'set'};
is verb(q{quit})->past_part, q{quit}  => q{past_part 'quit' --> 'quit'};
is verb(q{hears})->past_part, q{heard}  => q{past_part 'hears' --> 'heard'};
...
is verb(q{adding})->past_part, q{added}  => q{past_part 'adding' --> 'added'};
...
is verb(q{spilling})->past_part, q{spilled}  => q{past_part 'spilling' --> 'spilled'};
...
is verb(q{tries})->past_part, q{tried}  => q{past_part 'tries' --> 'tried'};
...
is verb(q{open})->past_part, q{opened}  => q{past_part 'open' --> 'opened'};
is verb(q{appear})->past_part, q{appeared}  => q{past_part 'appear' --> 'appeared'};
is verb(q{sit})->past_part, q{sat}  => q{past_part 'sit' --> 'sat'};
is verb(q{rids})->past_part, q{rid}  => q{past_part 'rids' --> 'rid'};
is verb(q{alighted})->past_part, q{alighted}  => q{past_part 'alighted' --> 'alighted'};
is verb(q{ridding})->past_part, q{rid}  => q{past_part 'ridding' --> 'rid'};
is verb(q{written})->past_part, q{written}  => q{past_part 'written' --> 'written'};
...
is verb(q{pays})->past_part, q{paid}  => q{past_part 'pays' --> 'paid'};
...
is verb(q{weds})->past_part, q{wed}  => q{past_part 'weds' --> 'wed'};
...
is verb(q{hides})->past_part, q{hidden}  => q{past_part 'hides' --> 'hidden'};
is verb(q{begets})->past_part, q{begotten}  => q{past_part 'begets' --> 'begotten'};
is verb(q{comes})->past_part, q{come}  => q{past_part 'comes' --> 'come'};
is verb(q{write})->past_part, q{written}  => q{past_part 'write' --> 'written'};
...
is verb(q{clad})->past_part, q{clad}  => q{past_part 'clad' --> 'clad'};
...
is verb(q{shorn})->past_part, q{shorn}  => q{past_part 'shorn' --> 'shorn'};
...
is verb(q{spins})->past_part, q{spun}  => q{past_part 'spins' --> 'spun'};
is verb(q{spelling})->past_part, q{spelled}  => q{past_part 'spelling' --> 'spelled'};
...
is verb(q{do})->past_part, q{done}  => q{past_part 'do' --> 'done'};
...
is verb(q{spreads})->past_part, q{spread}  => q{past_part 'spreads' --> 'spread'};
...
is verb(q{melted})->past_part, q{melted}  => q{past_part 'melted' --> 'melted'};
...
is verb(q{done})->past_part, q{done}  => q{past_part 'done' --> 'done'};
...
is verb(q{winding})->past_part, q{wound}  => q{past_part 'winding' --> 'wound'};
is verb(q{mow})->past_part, q{mown}  => q{past_part 'mow' --> 'mown'};
is verb(q{spin})->past_part, q{spun}  => q{past_part 'spin' --> 'spun'};
is verb(q{shoot})->past_part, q{shot}  => q{past_part 'shoot' --> 'shot'};
...
is verb(q{spills})->past_part, q{spilled}  => q{past_part 'spills' --> 'spilled'};
...
is verb(q{inputting})->past_part, q{input}  => q{past_part 'inputting' --> 'input'};
is verb(q{begot})->past_part, q{begotten}  => q{past_part 'begot' --> 'begotten'};
is verb(q{shine})->past_part, q{shone}  => q{past_part 'shine' --> 'shone'};
...
is verb(q{opening})->past_part, q{opened}  => q{past_part 'opening' --> 'opened'};
...
is verb(q{throwing})->past_part, q{thrown}  => q{past_part 'throwing' --> 'thrown'};
...
is verb(q{used})->past_part, q{used}  => q{past_part 'used' --> 'used'};
...
is verb(q{turning})->past_part, q{turned}  => q{past_part 'turning' --> 'turned'};
...
is verb(q{throw})->past_part, q{thrown}  => q{past_part 'throw' --> 'thrown'};
...
is verb(q{appears})->past_part, q{appeared}  => q{past_part 'appears' --> 'appeared'};
...
is verb(q{hid})->past_part, q{hidden}  => q{past_part 'hid' --> 'hidden'};
...
is verb(q{thrown})->past_part, q{thrown}  => q{past_part 'thrown' --> 'thrown'};
is verb(q{betting})->past_part, q{bet}  => q{past_part 'betting' --> 'bet'};
is verb(q{believe})->past_part, q{believed}  => q{past_part 'believe' --> 'believed'};
is verb(q{melting})->past_part, q{melted}  => q{past_part 'melting' --> 'melted'};
is verb(q{spits})->past_part, q{spat}  => q{past_part 'spits' --> 'spat'};
is verb(q{calling})->past_part, q{called}  => q{past_part 'calling' --> 'called'};
...
is verb(q{spilled})->past_part, q{spilled}  => q{past_part 'spilled' --> 'spilled'};
is verb(q{serves})->past_part, q{served}  => q{past_part 'serves' --> 'served'};
...
is verb(q{served})->past_part, q{served}  => q{past_part 'served' --> 'served'};
...
is verb(q{lighting})->past_part, q{lit}  => q{past_part 'lighting' --> 'lit'};
...
is verb(q{sends})->past_part, q{sent}  => q{past_part 'sends' --> 'sent'};
is verb(q{called})->past_part, q{called}  => q{past_part 'called' --> 'called'};
is verb(q{overtakes})->past_part, q{overtaken}  => q{past_part 'overtakes' --> 'overtaken'};
is verb(q{wedding})->past_part, q{wed}  => q{past_part 'wedding' --> 'wed'};
...
is verb(q{starts})->past_part, q{started}  => q{past_part 'starts' --> 'started'};
is verb(q{mistake})->past_part, q{mistaken}  => q{past_part 'mistake' --> 'mistaken'};
is verb(q{shoe})->past_part, q{shod}  => q{past_part 'shoe' --> 'shod'};
is verb(q{sold})->past_part, q{sold}  => q{past_part 'sold' --> 'sold'};
is verb(q{shuts})->past_part, q{shut}  => q{past_part 'shuts' --> 'shut'};
...
is verb(q{spill})->past_part, q{spilled}  => q{past_part 'spill' --> 'spilled'};
...
is verb(q{creating})->past_part, q{created}  => q{past_part 'creating' --> 'created'};
...
is verb(q{included})->past_part, q{included}  => q{past_part 'included' --> 'included'};
...
is verb(q{sewing})->past_part, q{sewn}  => q{past_part 'sewing' --> 'sewn'};
...
is verb(q{winds})->past_part, q{wound}  => q{past_part 'winds' --> 'wound'};
...
is verb(q{makes})->past_part, q{made}  => q{past_part 'makes' --> 'made'};
...
is verb(q{feeds})->past_part, q{fed}  => q{past_part 'feeds' --> 'fed'};
is verb(q{pay})->past_part, q{paid}  => q{past_part 'pay' --> 'paid'};
...
is verb(q{strung})->past_part, q{strung}  => q{past_part 'strung' --> 'strung'};
is verb(q{like})->past_part, q{liked}  => q{past_part 'like' --> 'liked'};
is verb(q{turn})->past_part, q{turned}  => q{past_part 'turn' --> 'turned'};
...
is verb(q{includes})->past_part, q{included}  => q{past_part 'includes' --> 'included'};
is verb(q{shot})->past_part, q{shot}  => q{past_part 'shot' --> 'shot'};
is verb(q{split})->past_part, q{split}  => q{past_part 'split' --> 'split'};
is verb(q{understood})->past_part, q{understood}  => q{past_part 'understood' --> 'understood'};
is verb(q{believes})->past_part, q{believed}  => q{past_part 'believes' --> 'believed'};
...
is verb(q{sling})->past_part, q{slung}  => q{past_part 'sling' --> 'slung'};
...
is verb(q{appearing})->past_part, q{appeared}  => q{past_part 'appearing' --> 'appeared'};
...
is verb(q{include})->past_part, q{included}  => q{past_part 'include' --> 'included'};
is verb(q{lending})->past_part, q{lent}  => q{past_part 'lending' --> 'lent'};
...
is verb(q{cut})->past_part, q{cut}  => q{past_part 'cut' --> 'cut'};
is verb(q{run})->past_part, q{run}  => q{past_part 'run' --> 'run'};
is verb(q{lent})->past_part, q{lent}  => q{past_part 'lent' --> 'lent'};
...
is verb(q{letting})->past_part, q{let}  => q{past_part 'letting' --> 'let'};
...
is verb(q{take})->past_part, q{taken}  => q{past_part 'take' --> 'taken'};
is verb(q{allows})->past_part, q{allowed}  => q{past_part 'allows' --> 'allowed'};
...
is verb(q{opened})->past_part, q{opened}  => q{past_part 'opened' --> 'opened'};
is verb(q{dwelt})->past_part, q{dwelt}  => q{past_part 'dwelt' --> 'dwelt'};
is verb(q{goes})->past_part, q{gone}  => q{past_part 'goes' --> 'gone'};
is verb(q{shutting})->past_part, q{shut}  => q{past_part 'shutting' --> 'shut'};
is verb(q{added})->past_part, q{added}  => q{past_part 'added' --> 'added'};
...
is verb(q{clothed})->past_part, q{clothed}  => q{past_part 'clothed' --> 'clothed'};
...
is verb(q{try})->past_part, q{tried}  => q{past_part 'try' --> 'tried'};
...
is verb(q{made})->past_part, q{made}  => q{past_part 'made' --> 'made'};
...
is verb(q{turns})->past_part, q{turned}  => q{past_part 'turns' --> 'turned'};
is verb(q{read})->past_part, q{read}  => q{past_part 'read' --> 'read'};
is verb(q{paying})->past_part, q{paid}  => q{past_part 'paying' --> 'paid'};
...
is verb(q{uses})->past_part, q{used}  => q{past_part 'uses' --> 'used'};
is verb(q{insisting})->past_part, q{insisted}  => q{past_part 'insisting' --> 'insisted'};
is verb(q{sending})->past_part, q{sent}  => q{past_part 'sending' --> 'sent'};
is verb(q{wore})->past_part, q{worn}  => q{past_part 'wore' --> 'worn'};
is verb(q{fits})->past_part, q{fitted}  => q{past_part 'fits' --> 'fitted'};
...
is verb(q{played})->past_part, q{played}  => q{past_part 'played' --> 'played'};
is verb(q{are})->past_part, q{been}  => q{past_part 'are' --> 'been'};
is verb(q{lend})->past_part, q{lent}  => q{past_part 'lend' --> 'lent'};
is verb(q{overhear})->past_part, q{overheard}  => q{past_part 'overhear' --> 'overheard'};
is verb(q{shears})->past_part, q{shorn}  => q{past_part 'shears' --> 'shorn'};
...
is verb(q{lends})->past_part, q{lent}  => q{past_part 'lends' --> 'lent'};
...
is verb(q{strike})->past_part, q{struck}  => q{past_part 'strike' --> 'struck'};
...
is verb(q{took})->past_part, q{taken}  => q{past_part 'took' --> 'taken'};
...
is verb(q{fit})->past_part, q{fitted}  => q{past_part 'fit' --> 'fitted'};
is verb(q{sewed})->past_part, q{sewn}  => q{past_part 'sewed' --> 'sewn'};
...
is verb(q{reads})->past_part, q{read}  => q{past_part 'reads' --> 'read'};
...
is verb(q{draw})->past_part, q{drawn}  => q{past_part 'draw' --> 'drawn'};
is verb(q{believing})->past_part, q{believed}  => q{past_part 'believing' --> 'believed'};
...
is verb(q{tried})->past_part, q{tried}  => q{past_part 'tried' --> 'tried'};
is verb(q{fitted})->past_part, q{fitted}  => q{past_part 'fitted' --> 'fitted'};
is verb(q{sing})->past_part, q{sung}  => q{past_part 'sing' --> 'sung'};
is verb(q{tells})->past_part, q{told}  => q{past_part 'tells' --> 'told'};
...
is verb(q{sleeps})->past_part, q{slept}  => q{past_part 'sleeps' --> 'slept'};
is verb(q{fed})->past_part, q{fed}  => q{past_part 'fed' --> 'fed'};
is verb(q{feel})->past_part, q{felt}  => q{past_part 'feel' --> 'felt'};
is verb(q{spinning})->past_part, q{spun}  => q{past_part 'spinning' --> 'spun'};
...
is verb(q{spelled})->past_part, q{spelled}  => q{past_part 'spelled' --> 'spelled'};
is verb(q{forgives})->past_part, q{forgiven}  => q{past_part 'forgives' --> 'forgiven'};
is verb(q{thinking})->past_part, q{thought}  => q{past_part 'thinking' --> 'thought'};
...
is verb(q{started})->past_part, q{started}  => q{past_part 'started' --> 'started'};
...
is verb(q{shear})->past_part, q{shorn}  => q{past_part 'shear' --> 'shorn'};
is verb(q{dying})->past_part, q{died}  => q{past_part 'dying' --> 'died'};
is verb(q{string})->past_part, q{strung}  => q{past_part 'string' --> 'strung'};
is verb(q{turned})->past_part, q{turned}  => q{past_part 'turned' --> 'turned'};
...
is verb(q{shoots})->past_part, q{shot}  => q{past_part 'shoots' --> 'shot'};
is verb(q{sheared})->past_part, q{shorn}  => q{past_part 'sheared' --> 'shorn'};
...
is verb(q{fitting})->past_part, q{fitted}  => q{past_part 'fitting' --> 'fitted'};
is verb(q{rides})->past_part, q{ridden}  => q{past_part 'rides' --> 'ridden'};
is verb(q{bound})->past_part, q{bound}  => q{past_part 'bound' --> 'bound'};
is verb(q{tell})->past_part, q{told}  => q{past_part 'tell' --> 'told'};
...
is verb(q{cuts})->past_part, q{cut}  => q{past_part 'cuts' --> 'cut'};
...
is verb(q{sell})->past_part, q{sold}  => q{past_part 'sell' --> 'sold'};
...
is verb(q{opens})->past_part, q{opened}  => q{past_part 'opens' --> 'opened'};
...
is verb(q{woven})->past_part, q{woven}  => q{past_part 'woven' --> 'woven'};
is verb(q{continue})->past_part, q{continued}  => q{past_part 'continue' --> 'continued'};
is verb(q{send})->past_part, q{sent}  => q{past_part 'send' --> 'sent'};
is verb(q{clothe})->past_part, q{clothed}  => q{past_part 'clothe' --> 'clothed'};
is verb(q{shooting})->past_part, q{shot}  => q{past_part 'shooting' --> 'shot'};
is verb(q{needed})->past_part, q{needed}  => q{past_part 'needed' --> 'needed'};
is verb(q{use})->past_part, q{used}  => q{past_part 'use' --> 'used'};
is verb(q{freezes})->past_part, q{frozen}  => q{past_part 'freezes' --> 'frozen'};
...
is verb(q{hearing})->past_part, q{heard}  => q{past_part 'hearing' --> 'heard'};
is verb(q{paid})->past_part, q{paid}  => q{past_part 'paid' --> 'paid'};
is verb(q{sprang})->past_part, q{sprung}  => q{past_part 'sprang' --> 'sprung'};
is verb(q{melt})->past_part, q{melted}  => q{past_part 'melt' --> 'melted'};
is verb(q{was})->past_part, q{been}  => q{past_part 'was' --> 'been'};
is verb(q{clothing})->past_part, q{clothed}  => q{past_part 'clothing' --> 'clothed'};
...
is verb(q{sews})->past_part, q{sewn}  => q{past_part 'sews' --> 'sewn'};
is verb(q{creche})->past_part, q{creched}  => q{past_part 'creche' --> 'creched'};
is verb(q{drawing})->past_part, q{drawn}  => q{past_part 'drawing' --> 'drawn'};
is verb(q{arise})->past_part, q{arisen}  => q{past_part 'arise' --> 'arisen'};
is verb(q{sleeping})->past_part, q{slept}  => q{past_part 'sleeping' --> 'slept'};
is verb(q{loses})->past_part, q{lost}  => q{past_part 'loses' --> 'lost'};
is verb(q{start})->past_part, q{started}  => q{past_part 'start' --> 'started'};
is verb(q{learn})->past_part, q{learned}  => q{past_part 'learn' --> 'learned'};
is verb(q{lying})->past_part, q{lain}  => q{past_part 'lying' --> 'lain'};
is verb(q{cutting})->past_part, q{cut}  => q{past_part 'cutting' --> 'cut'};
is verb(q{hew})->past_part, q{hewn}  => q{past_part 'hew' --> 'hewn'};
is verb(q{offers})->past_part, q{offered}  => q{past_part 'offers' --> 'offered'};
...
is verb(q{calls})->past_part, q{called}  => q{past_part 'calls' --> 'called'};
...
is verb(q{wetting})->past_part, q{wetted}  => q{past_part 'wetting' --> 'wetted'};
is verb(q{strikes})->past_part, q{struck}  => q{past_part 'strikes' --> 'struck'};
...
is verb(q{starting})->past_part, q{started}  => q{past_part 'starting' --> 'started'};
...
is verb(q{drawn})->past_part, q{drawn}  => q{past_part 'drawn' --> 'drawn'};
...
is verb(q{hidden})->past_part, q{hidden}  => q{past_part 'hidden' --> 'hidden'};
is verb(q{spent})->past_part, q{spent}  => q{past_part 'spent' --> 'spent'};
is verb(q{stick})->past_part, q{stuck}  => q{past_part 'stick' --> 'stuck'};
...
is verb(q{stringing})->past_part, q{strung}  => q{past_part 'stringing' --> 'strung'};
...
is verb(q{did})->past_part, q{done}  => q{past_part 'did' --> 'done'};
...
is verb(q{alighting})->past_part, q{alighted}  => q{past_part 'alighting' --> 'alighted'};
...
is verb(q{weaving})->past_part, q{woven}  => q{past_part 'weaving' --> 'woven'};
...
is verb(q{allowed})->past_part, q{allowed}  => q{past_part 'allowed' --> 'allowed'};
...
is verb(q{let})->past_part, q{let}  => q{past_part 'let' --> 'let'};
...
is verb(q{trying})->past_part, q{tried}  => q{past_part 'trying' --> 'tried'};
...
is verb(q{considered})->past_part, q{considered}  => q{past_part 'considered' --> 'considered'};
is verb(q{undertake})->past_part, q{undertaken}  => q{past_part 'undertake' --> 'undertaken'};
is verb(q{offering})->past_part, q{offered}  => q{past_part 'offering' --> 'offered'};
...
is verb(q{cladding})->past_part, q{clad}  => q{past_part 'cladding' --> 'clad'};
is verb(q{stop})->past_part, q{stopped}  => q{past_part 'stop' --> 'stopped'};
is verb(q{melts})->past_part, q{melted}  => q{past_part 'melts' --> 'melted'};
...
is verb(q{play})->past_part, q{played}  => q{past_part 'play' --> 'played'};
