...
ok verb(q{thinks})->is_singular  => q{is_singular: 'thinks'};
...
ok verb(q{mows})->is_singular  => q{is_singular: 'mows'};
...
ok verb(q{shines})->is_singular  => q{is_singular: 'shines'};
ok verb(q{lets})->is_singular  => q{is_singular: 'lets'};
ok verb(q{withholds})->is_singular  => q{is_singular: 'withholds'};
ok verb(q{spells})->is_singular  => q{is_singular: 'spells'};
ok verb(q{wets})->is_singular  => q{is_singular: 'wets'};
ok verb(q{reads})->is_singular  => q{is_singular: 'reads'};
...
ok verb(q{clads})->is_singular  => q{is_singular: 'clads'};
...
ok verb(q{lights})->is_singular  => q{is_singular: 'lights'};
...
ok verb(q{appears})->is_singular  => q{is_singular: 'appears'};
ok verb(q{might})->is_singular  => q{is_singular: 'might'};
ok verb(q{tells})->is_singular  => q{is_singular: 'tells'};
...
ok verb(q{teaches})->is_singular  => q{is_singular: 'teaches'};
ok verb(q{considers})->is_singular  => q{is_singular: 'considers'};
...
ok verb(q{sleeps})->is_singular  => q{is_singular: 'sleeps'};
...
ok verb(q{splits})->is_singular  => q{is_singular: 'splits'};
ok verb(q{spits})->is_singular  => q{is_singular: 'spits'};
ok verb(q{sticks})->is_singular  => q{is_singular: 'sticks'};
...
ok verb(q{serves})->is_singular  => q{is_singular: 'serves'};
...
ok verb(q{writes})->is_singular  => q{is_singular: 'writes'};
ok verb(q{shows})->is_singular  => q{is_singular: 'shows'};
ok verb(q{creates})->is_singular  => q{is_singular: 'creates'};
...
ok verb(q{shoots})->is_singular  => q{is_singular: 'shoots'};
...
ok verb(q{cuts})->is_singular  => q{is_singular: 'cuts'};
ok verb(q{strives})->is_singular  => q{is_singular: 'strives'};
ok verb(q{takes})->is_singular  => q{is_singular: 'takes'};
ok verb(q{flings})->is_singular  => q{is_singular: 'flings'};
ok verb(q{stands})->is_singular  => q{is_singular: 'stands'};
ok verb(q{sends})->is_singular  => q{is_singular: 'sends'};
ok verb(q{overtakes})->is_singular  => q{is_singular: 'overtakes'};
ok verb(q{weaves})->is_singular  => q{is_singular: 'weaves'};
ok verb(q{starts})->is_singular  => q{is_singular: 'starts'};
ok verb(q{sells})->is_singular  => q{is_singular: 'sells'};
ok verb(q{eats})->is_singular  => q{is_singular: 'eats'};
ok verb(q{becomes})->is_singular  => q{is_singular: 'becomes'};
ok verb(q{shuts})->is_singular  => q{is_singular: 'shuts'};
...
ok verb(q{opens})->is_singular  => q{is_singular: 'opens'};
...
ok verb(q{freezes})->is_singular  => q{is_singular: 'freezes'};
...
ok verb(q{sets})->is_singular  => q{is_singular: 'sets'};
ok verb(q{hears})->is_singular  => q{is_singular: 'hears'};
ok verb(q{rives})->is_singular  => q{is_singular: 'rives'};
ok verb(q{speeds})->is_singular  => q{is_singular: 'speeds'};
ok verb(q{slings})->is_singular  => q{is_singular: 'slings'};
...
ok verb(q{winds})->is_singular  => q{is_singular: 'winds'};
ok verb(q{lays})->is_singular  => q{is_singular: 'lays'};
ok verb(q{makes})->is_singular  => q{is_singular: 'makes'};
ok verb(q{tries})->is_singular  => q{is_singular: 'tries'};
ok verb(q{shakes})->is_singular  => q{is_singular: 'shakes'};
ok verb(q{sews})->is_singular  => q{is_singular: 'sews'};
...
ok verb(q{offers})->is_singular  => q{is_singular: 'offers'};
ok verb(q{foresees})->is_singular  => q{is_singular: 'foresees'};
ok verb(q{pays})->is_singular  => q{is_singular: 'pays'};
ok verb(q{calls})->is_singular  => q{is_singular: 'calls'};
...
ok verb(q{feeds})->is_singular  => q{is_singular: 'feeds'};
ok verb(q{strikes})->is_singular  => q{is_singular: 'strikes'};
ok verb(q{weds})->is_singular  => q{is_singular: 'weds'};
...
ok verb(q{adds})->is_singular  => q{is_singular: 'adds'};
ok verb(q{hides})->is_singular  => q{is_singular: 'hides'};
...
ok verb(q{includes})->is_singular  => q{is_singular: 'includes'};
ok verb(q{shits})->is_singular  => q{is_singular: 'shits'};
ok verb(q{believes})->is_singular  => q{is_singular: 'believes'};
...
ok verb(q{inputs})->is_singular  => q{is_singular: 'inputs'};
...
ok verb(q{works})->is_singular  => q{is_singular: 'works'};
...
ok verb(q{alights})->is_singular  => q{is_singular: 'alights'};
ok verb(q{allows})->is_singular  => q{is_singular: 'allows'};
...
ok verb(q{spins})->is_singular  => q{is_singular: 'spins'};
...
ok verb(q{spreads})->is_singular  => q{is_singular: 'spreads'};
...
ok verb(q{throws})->is_singular  => q{is_singular: 'throws'};
...
ok verb(q{turns})->is_singular  => q{is_singular: 'turns'};
ok verb(q{gilds})->is_singular  => q{is_singular: 'gilds'};
ok verb(q{plays})->is_singular  => q{is_singular: 'plays'};
ok verb(q{could})->is_singular  => q{is_singular: 'could'};
ok verb(q{clothes})->is_singular  => q{is_singular: 'clothes'};
ok verb(q{does})->is_singular  => q{is_singular: 'does'};
...
ok verb(q{uses})->is_singular  => q{is_singular: 'uses'};
ok verb(q{fits})->is_singular  => q{is_singular: 'fits'};
...
ok verb(q{spills})->is_singular  => q{is_singular: 'spills'};
ok verb(q{bursts})->is_singular  => q{is_singular: 'bursts'};
ok verb(q{deals})->is_singular  => q{is_singular: 'deals'};
ok verb(q{melts})->is_singular  => q{is_singular: 'melts'};
ok verb(q{draws})->is_singular  => q{is_singular: 'draws'};
ok verb(q{shears})->is_singular  => q{is_singular: 'shears'};
ok verb(q{strips})->is_singular  => q{is_singular: 'strips'};
ok verb(q{strings})->is_singular  => q{is_singular: 'strings'};
ok verb(q{lives})->is_singular  => q{is_singular: 'lives'};
ok verb(q{lends})->is_singular  => q{is_singular: 'lends'};
