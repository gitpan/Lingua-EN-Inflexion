...
is verb(q{shine})->singular, q{shines}  => q{singular: 'shine' --> 'shines'};
is verb(q{shines})->singular,   q{shines}  => q{singular: 'shines' --> 'shines'};
is verb(q{wend})->singular, q{wends}  => q{singular: 'wend' --> 'wends'};
is verb(q{wends})->singular,   q{wends}  => q{singular: 'wends' --> 'wends'};
is verb(q{strike})->singular, q{strikes}  => q{singular: 'strike' --> 'strikes'};
is verb(q{strikes})->singular,   q{strikes}  => q{singular: 'strikes' --> 'strikes'};
...
is verb(q{serve})->singular, q{serves}  => q{singular: 'serve' --> 'serves'};
is verb(q{serves})->singular,   q{serves}  => q{singular: 'serves' --> 'serves'};
is verb(q{weep})->singular, q{weeps}  => q{singular: 'weep' --> 'weeps'};
is verb(q{weeps})->singular,   q{weeps}  => q{singular: 'weeps' --> 'weeps'};
is verb(q{fit})->singular, q{fits}  => q{singular: 'fit' --> 'fits'};
is verb(q{fits})->singular,   q{fits}  => q{singular: 'fits' --> 'fits'};
is verb(q{bleed})->singular, q{bleeds}  => q{singular: 'bleed' --> 'bleeds'};
is verb(q{bleeds})->singular,   q{bleeds}  => q{singular: 'bleeds' --> 'bleeds'};
is verb(q{shut})->singular, q{shuts}  => q{singular: 'shut' --> 'shuts'};
is verb(q{shuts})->singular,   q{shuts}  => q{singular: 'shuts' --> 'shuts'};
is verb(q{light})->singular, q{lights}  => q{singular: 'light' --> 'lights'};
is verb(q{lights})->singular,   q{lights}  => q{singular: 'lights' --> 'lights'};
...
is verb(q{wind})->singular, q{winds}  => q{singular: 'wind' --> 'winds'};
is verb(q{winds})->singular,   q{winds}  => q{singular: 'winds' --> 'winds'};
...
is verb(q{throw})->singular, q{throws}  => q{singular: 'throw' --> 'throws'};
is verb(q{throws})->singular,   q{throws}  => q{singular: 'throws' --> 'throws'};
is verb(q{draw})->singular, q{draws}  => q{singular: 'draw' --> 'draws'};
is verb(q{draws})->singular,   q{draws}  => q{singular: 'draws' --> 'draws'};
...
is verb(q{wet})->singular, q{wets}  => q{singular: 'wet' --> 'wets'};
is verb(q{wets})->singular,   q{wets}  => q{singular: 'wets' --> 'wets'};
is verb(q{spell})->singular, q{spells}  => q{singular: 'spell' --> 'spells'};
is verb(q{spells})->singular,   q{spells}  => q{singular: 'spells' --> 'spells'};
is verb(q{offer})->singular, q{offers}  => q{singular: 'offer' --> 'offers'};
is verb(q{offers})->singular,   q{offers}  => q{singular: 'offers' --> 'offers'};
...
is verb(q{believe})->singular, q{believes}  => q{singular: 'believe' --> 'believes'};
is verb(q{believes})->singular,   q{believes}  => q{singular: 'believes' --> 'believes'};
...
is verb(q{add})->singular, q{adds}  => q{singular: 'add' --> 'adds'};
is verb(q{adds})->singular,   q{adds}  => q{singular: 'adds' --> 'adds'};
...
is verb(q{alight})->singular, q{alights}  => q{singular: 'alight' --> 'alights'};
is verb(q{alights})->singular,   q{alights}  => q{singular: 'alights' --> 'alights'};
...
is verb(q{shear})->singular, q{shears}  => q{singular: 'shear' --> 'shears'};
is verb(q{shears})->singular,   q{shears}  => q{singular: 'shears' --> 'shears'};
is verb(q{string})->singular, q{strings}  => q{singular: 'string' --> 'strings'};
is verb(q{strings})->singular,   q{strings}  => q{singular: 'strings' --> 'strings'};
is verb(q{consider})->singular, q{considers}  => q{singular: 'consider' --> 'considers'};
is verb(q{considers})->singular,   q{considers}  => q{singular: 'considers' --> 'considers'};
...
is verb(q{freeze})->singular, q{freezes}  => q{singular: 'freeze' --> 'freezes'};
is verb(q{freezes})->singular,   q{freezes}  => q{singular: 'freezes' --> 'freezes'};
...
is verb(q{tell})->singular, q{tells}  => q{singular: 'tell' --> 'tells'};
is verb(q{tells})->singular,   q{tells}  => q{singular: 'tells' --> 'tells'};
...
is verb(q{create})->singular, q{creates}  => q{singular: 'create' --> 'creates'};
is verb(q{creates})->singular,   q{creates}  => q{singular: 'creates' --> 'creates'};
is verb(q{work})->singular, q{works}  => q{singular: 'work' --> 'works'};
is verb(q{works})->singular,   q{works}  => q{singular: 'works' --> 'works'};
...
is verb(q{hear})->singular, q{hears}  => q{singular: 'hear' --> 'hears'};
is verb(q{hears})->singular,   q{hears}  => q{singular: 'hears' --> 'hears'};
...
is verb(q{sell})->singular, q{sells}  => q{singular: 'sell' --> 'sells'};
is verb(q{sells})->singular,   q{sells}  => q{singular: 'sells' --> 'sells'};
...
is verb(q{spill})->singular, q{spills}  => q{singular: 'spill' --> 'spills'};
is verb(q{spills})->singular,   q{spills}  => q{singular: 'spills' --> 'spills'};
...
is verb(q{clothe})->singular, q{clothes}  => q{singular: 'clothe' --> 'clothes'};
is verb(q{clothes})->singular,   q{clothes}  => q{singular: 'clothes' --> 'clothes'};
is verb(q{send})->singular, q{sends}  => q{singular: 'send' --> 'sends'};
is verb(q{sends})->singular,   q{sends}  => q{singular: 'sends' --> 'sends'};
...
is verb(q{use})->singular, q{uses}  => q{singular: 'use' --> 'uses'};
is verb(q{uses})->singular,   q{uses}  => q{singular: 'uses' --> 'uses'};
...
is verb(q{call})->singular, q{calls}  => q{singular: 'call' --> 'calls'};
is verb(q{calls})->singular,   q{calls}  => q{singular: 'calls' --> 'calls'};
is verb(q{sew})->singular, q{sews}  => q{singular: 'sew' --> 'sews'};
is verb(q{sews})->singular,   q{sews}  => q{singular: 'sews' --> 'sews'};
...
is verb(q{melt})->singular, q{melts}  => q{singular: 'melt' --> 'melts'};
is verb(q{melts})->singular,   q{melts}  => q{singular: 'melts' --> 'melts'};
...
is verb(q{appear})->singular, q{appears}  => q{singular: 'appear' --> 'appears'};
is verb(q{appears})->singular,   q{appears}  => q{singular: 'appears' --> 'appears'};
is verb(q{open})->singular, q{opens}  => q{singular: 'open' --> 'opens'};
is verb(q{opens})->singular,   q{opens}  => q{singular: 'opens' --> 'opens'};
is verb(q{arise})->singular, q{arises}  => q{singular: 'arise' --> 'arises'};
is verb(q{arises})->singular,   q{arises}  => q{singular: 'arises' --> 'arises'};
is verb(q{hide})->singular, q{hides}  => q{singular: 'hide' --> 'hides'};
is verb(q{hides})->singular,   q{hides}  => q{singular: 'hides' --> 'hides'};
...
is verb(q{start})->singular, q{starts}  => q{singular: 'start' --> 'starts'};
is verb(q{starts})->singular,   q{starts}  => q{singular: 'starts' --> 'starts'};
...
is verb(q{think})->singular, q{thinks}  => q{singular: 'think' --> 'thinks'};
is verb(q{thinks})->singular,   q{thinks}  => q{singular: 'thinks' --> 'thinks'};
...
is verb(q{pay})->singular, q{pays}  => q{singular: 'pay' --> 'pays'};
is verb(q{pays})->singular,   q{pays}  => q{singular: 'pays' --> 'pays'};
...
is verb(q{turn})->singular, q{turns}  => q{singular: 'turn' --> 'turns'};
is verb(q{turns})->singular,   q{turns}  => q{singular: 'turns' --> 'turns'};
...
is verb(q{split})->singular, q{splits}  => q{singular: 'split' --> 'splits'};
is verb(q{splits})->singular,   q{splits}  => q{singular: 'splits' --> 'splits'};
is verb(q{write})->singular, q{writes}  => q{singular: 'write' --> 'writes'};
is verb(q{writes})->singular,   q{writes}  => q{singular: 'writes' --> 'writes'};
...
is verb(q{sling})->singular, q{slings}  => q{singular: 'sling' --> 'slings'};
is verb(q{slings})->singular,   q{slings}  => q{singular: 'slings' --> 'slings'};
...
is verb(q{include})->singular, q{includes}  => q{singular: 'include' --> 'includes'};
is verb(q{includes})->singular,   q{includes}  => q{singular: 'includes' --> 'includes'};
...
is verb(q{cut})->singular, q{cuts}  => q{singular: 'cut' --> 'cuts'};
is verb(q{cuts})->singular,   q{cuts}  => q{singular: 'cuts' --> 'cuts'};
is verb(q{run})->singular, q{runs}  => q{singular: 'run' --> 'runs'};
is verb(q{runs})->singular,   q{runs}  => q{singular: 'runs' --> 'runs'};
is verb(q{weave})->singular, q{weaves}  => q{singular: 'weave' --> 'weaves'};
is verb(q{weaves})->singular,   q{weaves}  => q{singular: 'weaves' --> 'weaves'};
is verb(q{make})->singular, q{makes}  => q{singular: 'make' --> 'makes'};
is verb(q{makes})->singular,   q{makes}  => q{singular: 'makes' --> 'makes'};
...
is verb(q{allow})->singular, q{allows}  => q{singular: 'allow' --> 'allows'};
is verb(q{allows})->singular,   q{allows}  => q{singular: 'allows' --> 'allows'};
is verb(q{clad})->singular, q{clads}  => q{singular: 'clad' --> 'clads'};
is verb(q{clads})->singular,   q{clads}  => q{singular: 'clads' --> 'clads'};
...
is verb(q{input})->singular, q{inputs}  => q{singular: 'input' --> 'inputs'};
is verb(q{inputs})->singular,   q{inputs}  => q{singular: 'inputs' --> 'inputs'};
is verb(q{rise})->singular, q{rises}  => q{singular: 'rise' --> 'rises'};
is verb(q{rises})->singular,   q{rises}  => q{singular: 'rises' --> 'rises'};
is verb(q{stick})->singular, q{sticks}  => q{singular: 'stick' --> 'sticks'};
is verb(q{sticks})->singular,   q{sticks}  => q{singular: 'sticks' --> 'sticks'};
is verb(q{slide})->singular, q{slides}  => q{singular: 'slide' --> 'slides'};
is verb(q{slides})->singular,   q{slides}  => q{singular: 'slides' --> 'slides'};
is verb(q{take})->singular, q{takes}  => q{singular: 'take' --> 'takes'};
is verb(q{takes})->singular,   q{takes}  => q{singular: 'takes' --> 'takes'};
...
is verb(q{do})->singular, q{does}  => q{singular: 'do' --> 'does'};
is verb(q{does})->singular,   q{does}  => q{singular: 'does' --> 'does'};
is verb(q{wed})->singular, q{weds}  => q{singular: 'wed' --> 'weds'};
is verb(q{weds})->singular,   q{weds}  => q{singular: 'weds' --> 'weds'};
...
is verb(q{set})->singular, q{sets}  => q{singular: 'set' --> 'sets'};
is verb(q{sets})->singular,   q{sets}  => q{singular: 'sets' --> 'sets'};
is verb(q{teach})->singular, q{teaches}  => q{singular: 'teach' --> 'teaches'};
is verb(q{teaches})->singular,   q{teaches}  => q{singular: 'teaches' --> 'teaches'};
...
is verb(q{spread})->singular, q{spreads}  => q{singular: 'spread' --> 'spreads'};
is verb(q{spreads})->singular,   q{spreads}  => q{singular: 'spreads' --> 'spreads'};
is verb(q{wake})->singular, q{wakes}  => q{singular: 'wake' --> 'wakes'};
is verb(q{wakes})->singular,   q{wakes}  => q{singular: 'wakes' --> 'wakes'};
is verb(q{try})->singular, q{tries}  => q{singular: 'try' --> 'tries'};
is verb(q{tries})->singular,   q{tries}  => q{singular: 'tries' --> 'tries'};
...
is verb(q{let})->singular, q{lets}  => q{singular: 'let' --> 'lets'};
is verb(q{lets})->singular,   q{lets}  => q{singular: 'lets' --> 'lets'};
...
is verb(q{read})->singular, q{reads}  => q{singular: 'read' --> 'reads'};
is verb(q{reads})->singular,   q{reads}  => q{singular: 'reads' --> 'reads'};
...
is verb(q{mow})->singular, q{mows}  => q{singular: 'mow' --> 'mows'};
is verb(q{mows})->singular,   q{mows}  => q{singular: 'mows' --> 'mows'};
is verb(q{bind})->singular, q{binds}  => q{singular: 'bind' --> 'binds'};
is verb(q{binds})->singular,   q{binds}  => q{singular: 'binds' --> 'binds'};
is verb(q{shoot})->singular, q{shoots}  => q{singular: 'shoot' --> 'shoots'};
is verb(q{shoots})->singular,   q{shoots}  => q{singular: 'shoots' --> 'shoots'};
is verb(q{spin})->singular, q{spins}  => q{singular: 'spin' --> 'spins'};
is verb(q{spins})->singular,   q{spins}  => q{singular: 'spins' --> 'spins'};
...
is verb(q{lend})->singular, q{lends}  => q{singular: 'lend' --> 'lends'};
is verb(q{lends})->singular,   q{lends}  => q{singular: 'lends' --> 'lends'};
...
is verb(q{feed})->singular, q{feeds}  => q{singular: 'feed' --> 'feeds'};
is verb(q{feeds})->singular,   q{feeds}  => q{singular: 'feeds' --> 'feeds'};
...
is verb(q{play})->singular, q{plays}  => q{singular: 'play' --> 'plays'};
is verb(q{plays})->singular,   q{plays}  => q{singular: 'plays' --> 'plays'};
...
is verb(q{sleep})->singular, q{sleeps}  => q{singular: 'sleep' --> 'sleeps'};
is verb(q{sleeps})->singular,   q{sleeps}  => q{singular: 'sleeps' --> 'sleeps'};
